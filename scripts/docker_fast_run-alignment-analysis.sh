...
#Docker parameters
NWELLS=96
DOCKERCMD="docker run --rm -v $1/data/LINCS:/data -e NWELLS=$NWELLS biodepot/rnaseq-umi-cpp "
...
echo "$DOCKERCMD umisplit -v -l 16 -m 1 -N 1 -t $THREAD_NUMBER -b $BARCODE_FILE $SEQ_FILES"
